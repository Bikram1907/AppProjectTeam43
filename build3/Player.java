...
public class Player extends Observable implements Serializable {
    ...
    private Territories attackingCountry;
    private String defendingCountry;
    private Territories fortifyingCountry;
    private Territories sourceCountry;
    ...
    /**
     * To set the attacking country.
     * @param attackingCountry
     */
    public void setAttackingCountry(Territories attackingCountry) {
        this.attackingCountry = attackingCountry;
    }

    /**
     * To set the defending country.
    ...
    /**
     * To set the fortifying country.
     * @param fortifyingCountry
     */
    public void setFortifyingCountry(Territories fortifyingCountry) {
        this.fortifyingCountry = fortifyingCountry;
    }

    /**
     * To set the source Country.
     * @param sourceCountry
     */
    public void setSourceCountry(Territories sourceCountry) {
        this.sourceCountry = sourceCountry;
    }

    /**
     * To get the attacking country.
     * @return attacking country
     */
    public Territories getAttackingCountry() {
        return attackingCountry;
    }

    /**
     * To get the defendingCountry
     ...
     */
    public Territories getFortifyingCountry() {
     ...
     * @return source country.
     */
    public Territories getSourceCountry() {
        return sourceCountry;
    }

    /**
     * To find whether player is AI or not.
     * @return
     */
